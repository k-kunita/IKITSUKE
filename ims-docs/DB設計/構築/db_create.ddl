...
create table shop_info (
  shop_id INT not null auto_increment comment '店舗ＩＤ	 連番で作成'
  ...
  , update_time DATETIME not null comment '更新日付	 yyyymmddhhmm'
...
create table shop_category (
  category_id INT not null auto_increment comment '店舗カテゴリＩＤ	 ログインユーザ作成時に連番で８レコード作成'
