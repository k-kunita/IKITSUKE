...
public class ShopDetailController {
    ...
    public ModelAndView shopDetail(@PathVariable("categoryId") String categoryId, @PathVariable("shopId") String shopId, @ModelAttribute("ShopEditOutputForm") ShopEditOutputForm shopEditOutputForm, @ModelAttribute("ShopEditInputForm") ShopEditInputForm shopEditInputForm) {
    ...
    public String doShopEdit(@PathVariable("categoryId") String categoryId, @ModelAttribute("ShopEditInputForm") ShopEditInputForm shopEditInputForm, HttpServletRequest request) {
    ...
    public String doShopDelete(@PathVariable("categoryId") String categoryId, @PathVariable("shopId") String shopId, HttpServletRequest request) {
